...
return [
    ...
    */
    ...
    'signin_h1' => 'Sign in to app',
    'password_forgot' => 'Forgot your password?',
    'remember' => 'Remember me',
    'dont_have_account' => "Don't have an account?",

    'forgot_p' => 'Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.',
    'eprl'=>'Email password reset link',

    'reset_h1' => 'Reset password',

    'confirm_h1' => 'Confirm email',
    'confirm_p' => 'Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.',
    'verification_link_sent'=>'A new verification link has been sent to the email address you provided during registration.',
    'confirm_reset' => 'Resend Verification Email',
