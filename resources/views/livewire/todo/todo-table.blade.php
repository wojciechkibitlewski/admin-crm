...
@include('livewire.todo.includes.showIdeaAllModal')
    ...
    var ideaAll = document.querySelector("#ideaAll");
    var doneAll = document.querySelector("#doneAll");
    var workingAll = document.querySelector("#workingAll");
    var waitingAll = document.querySelector("#waitingAll");
    ...
    new Sortable(doneAll, {
        group: 'shared',
        animation: 150,
        onSort: function (evt) {
            let boxIds = Array.from(doneAll.querySelectorAll('[drag-item]'))
                .map(itemEl => itemEl.getAttribute('drag-item'));
            @this.reorderWithinDiv(boxIds);
        },
    ...
    new Sortable(workingAll, {
        group: 'shared',
        animation: 150,
        onSort: function (evt) {
            let boxIds = Array.from(workingAll.querySelectorAll('[drag-item]'))
                .map(itemEl => itemEl.getAttribute('drag-item'));
            @this.reorderWithinDiv(boxIds);
        },
    ...
    new Sortable(waitingAll, {
        group: 'shared',
        animation: 150,
        onSort: function (evt) {
            let boxIds = Array.from(waitingAll.querySelectorAll('[drag-item]'))
                .map(itemEl => itemEl.getAttribute('drag-item'));
            @this.reorderWithinDiv(boxIds);
        },
    ...
    new Sortable(ideaAll, {
        group: 'shared',
        animation: 150,
        onSort: function (evt) {
            let boxIds = Array.from(ideaAll.querySelectorAll('[drag-item]'))
                .map(itemEl => itemEl.getAttribute('drag-item'));
            @this.reorderWithinDiv(boxIds);
        },
